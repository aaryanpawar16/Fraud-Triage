...
|---|---|---|---|
| **Primary: accuracy** | {baseline_scores['accuracy']:.0%} ({baseline_scores['confusion']['tp']+baseline_scores['confusion']['tn']}/{baseline_scores['n_cases']}) | {agent_scores['accuracy']:.0%} ({agent_scores['confusion']['tp']+agent_scores['confusion']['tn']}/{agent_scores['n_cases']}) | {agent_scores['accuracy']-baseline_scores['accuracy']:+.0%} |
