      ...
      <div className="grid grid-cols-[auto_1fr_1fr]">
        ...
        <div className={`border-r border-border bg-surface ${cellBase} text-center`}>
          <div className="font-display text-3xl font-semibold text-text">
            <CountUpNumber target={s.correct_no_review} />
          </div>
        ...
        <div className={`bg-fraud-dim/10 ${cellBase} text-center`}>
          <div className="font-display text-3xl font-semibold text-fraud">
            <CountUpNumber target={s.wrong_no_review} />
          </div>
        ...
        <div className={`border-r border-t border-border bg-surface ${cellBase} text-center`}>
          <div className="font-display text-3xl font-semibold text-text">
            <CountUpNumber target={s.correct_with_review} />
          </div>
        ...
        <div className={`border-t border-border bg-review-dim/10 ${cellBase} text-center`}>
          <div className="font-display text-3xl font-semibold text-review">
            <CountUpNumber target={s.wrong_with_review} />
          </div>
