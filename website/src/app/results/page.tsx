...
export const metadata: Metadata = {
  title: "Results — Fraud Triage Agent",
  description: "Full evaluation metrics, confidence calibration, hard case analysis.",
};
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-16">
      ...
      <p className="mt-3 max-w-2xl text-text-dim">
        ...
        The headline result first, then the full numbers underneath it.
      </p>
      ...
      <p className="mt-3 max-w-2xl text-text-dim">
        Raw accuracy favors the baseline — 67% for the agent against 100%
        for a single prompt on the same 12 cases. Read alone that looks
        like a regression; read against the safety breakdown above, it's
        the expected shape of trading a small amount of raw accuracy for
        a system that knows when it's wrong.
      </p>
      ...
      <p className="mt-3 max-w-2xl text-text-dim">
        ...
        <Link href="/case-list/case_06" className="text-review hover:underline">
          case_06
        </Link>
